...
| 분야     | 기술 스택       | 선택 이유                                                             |
| --------- | ----------- | ----------------------------------------------------------------- |
| Back-End    | Spring boot | 스프링 프레임워크의 장점을 그대로 유지하면서, 빠르고 효율적인 웹 애플리케이션을 개발할 수 있기 때문임.        |
| Front-End  | Vue.js      | 뛰어난 반응성과 유연성을 제공하여 웹 애플리케이션의 성능을 향상시키고 사용자 인터페이스를 부드럽게 만들어주기 때문임. |
| DB | MariaDB     | 오픈 소스이면서도 안정적이며 확장성이 뛰어나기 때문임.                                    |
