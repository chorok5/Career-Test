      ...
      <main class="main-content">
        ...
        <div style="display: flex; justify-content: space-between;">
          <div class="userInfo mb-4">
            <div class="mb-4">
              <h4 style="text-align: left; font-family: 'sjl';">개인 정보</h4>
            </div>
          ...
          <div class="notice mb-4">
            <div class="mb-4">
              ...
              <h4 v-if="grade == 2" style="text-align: left; font-family: 'sjl';">일지 미작성 상담 ({{ needList.length }}건)
              </h4>
            </div>
            <div class="scrollDiv">
            ...
            <div class="timeList">
              <ul>
                <li v-for="row in schedule" :key="row.title">
                  ...
                  <span v-if="this.grade >= 2">{{ row.time }}&ensp;|&ensp; {{ row.title }}&ensp; ( {{ row.stuName }}
                    )</span>
                </li>
